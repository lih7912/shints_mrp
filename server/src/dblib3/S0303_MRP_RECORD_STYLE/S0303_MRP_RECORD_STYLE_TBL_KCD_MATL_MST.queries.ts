...
const moduleQuery_S0303_MRP_RECORD_STYLE_TBL_KCD_MATL_MST = {
    Query: {
        mgrQuery_S0303_MRP_RECORD_STYLE_TBL_KCD_MATL_MST: async (_, args) => {
            var tSQL = '';
            var tSQL1 = '';
...
export default moduleQuery_S0303_MRP_RECORD_STYLE_TBL_KCD_MATL_MST;
