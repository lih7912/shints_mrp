...
const moduleQuery_S0519_4_1 = {
    Query: {
        mgrQueryS0519_4_1: async (_, args) => {
            var tSQL = '';
        ...
        mgrQueryS0519_4_2: async (_, args) => {
            var tSQL = '';
        ...
        // 4_2 Backup
        mgrQueryS0519_4_2_1: async (_, args) => {
            var tSQL = '';
...
export default moduleQuery_S0519_4_1;
