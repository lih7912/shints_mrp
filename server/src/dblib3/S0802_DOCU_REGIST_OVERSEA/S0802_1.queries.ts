...
const moduleQuery_S0802_1 = {
    Query: {
        mgrQueryS0802_CODE: async (_, args) => {
            var tWObj = {};
...
export default moduleQuery_S0802_1;
