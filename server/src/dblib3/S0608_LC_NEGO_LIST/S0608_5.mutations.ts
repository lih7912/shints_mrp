...
const moduleMutation_S0608_5 = {
    Mutation: {
        mgrInsert_S0608_5_INSERT_BILL: async (_, args, contextValue) => {
        ...
        mgrInsert_S0608_5_DELETE_BILL: async (_, args, contextValue) => {
            var tRetDate = AFLib.getCurrTime();
            var tRetDate1 = tRetDate.substring(0, 8);
            var tUserInfo = AFLib.getUserInfo(contextValue);
        ...
        mgrInsert_S0608_5_INSERT_DC: async (_, args, contextValue) => {
            var tRetDate = AFLib.getCurrTime();
            var tRetDate1 = tRetDate.substring(0, 8);
            var tUserInfo = AFLib.getUserInfo(contextValue);
        ...
        mgrInsert_S0608_5_DELETE_DC: async (_, args, contextValue) => {
            var tRetDate = AFLib.getCurrTime();
            var tRetDate1 = tRetDate.substring(0, 8);
            var tUserInfo = AFLib.getUserInfo(contextValue);
...
export default moduleMutation_S0608_5;
