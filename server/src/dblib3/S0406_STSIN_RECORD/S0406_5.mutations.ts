...
const moduleMutation_S0406_5 = {
    Mutation: {
        mgrInsert_S0406_5: async (_, args, contextValue) => {
            //
...
*/
            ...
            for (tIdx = 0; tIdx < args.datas.length; tIdx++) {
                ...
                var tBefInQty = parseInt(tInput.BEF_IN_QTY);
                ...
                if (parseFloat(tInput.TEMP_PRICE) > 0)
                    m_MatlPrice = parseFloat(tInput.TEMP_PRICE);
...
export default moduleMutation_S0406_5;
