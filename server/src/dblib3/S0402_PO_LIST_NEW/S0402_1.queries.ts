...
const moduleQuery_S0402_1 = {
    Query: {
        mgrQueryS0402_1_CODE: async (_, args) => {
            var tWObj = {};
            let sqlStr = `
                select
                    PO_CD,
        ...
        mgrQueryS0402_1_CODE2: async (_, args) => {
            var tWObj = {};
...
export default moduleQuery_S0402_1;
