...
const moduleQuery_S051901_4_1 = {
    Query: {
        mgrQueryS051901_4_1: async (_, args) => {
            var tSQL = '';
        ...
        mgrQueryS051901_4_2: async (_, args) => {
            var tSQL = '';
        ...
        // 4_2 Backup
        mgrQueryS051901_4_2_1: async (_, args) => {
            var tSQL = '';
...
export default moduleQuery_S051901_4_1;
