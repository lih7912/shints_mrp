// MGR_S043401_1.typeDefs.js

// 데이터 형식(typeDefs) 지정하기 위한 gql 불러오기
import { gql } from 'apollo-server';

// export default 활용해 gql typeDefs 내보내기
const moduleTypedefs_S043401_1 = gql`
    type T_S043401_1 {
        PO_CD: String
        PO_SEQ: String
        ORDER_CD: String
    ...
    input I_S043401_CODE {
        BUYER_CD: String
    }

    type T_S043401_1_CODE {
        SHIP_LINE: [BASE_QRY_KCD_CODE!]!
        CURR_CD: [BASE_QRY_KCD_CODE!]!
        COMPOSITION: [BASE_QRY_KCD_CODE!]!
    ...
    type Query {
        mgrQueryS043401_1_CODE: T_S043401_1_CODE!
    }
`;

export default moduleTypedefs_S043401_1;
