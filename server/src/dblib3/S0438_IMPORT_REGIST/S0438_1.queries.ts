...
const moduleQuery_S0438_1 = {
    Query: {
        mgrQueryS0438_CODE: async (_, args) => {
            var tWObj = {};

            var tArray = ['', 'Ship', 'Import', 'End'];
            var tArray1 = [' ', 'Ship', 'Import', 'End'];
            let tRet = [];
            ...
            var tArray = ['', '제품수입', '자재수입'];
            var tArray1 = [' ', '제품수입', '자재수입'];
            let tRet = [];
            tArray.forEach((col, i) => {
                var tObj = {};
                tObj.CD_CODE = tArray[i];
...
export default moduleQuery_S0438_1;
