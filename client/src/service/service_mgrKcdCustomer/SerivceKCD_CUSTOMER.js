...
export class ServiceKCD_CUSTOMER {
    async getDatasByParamKCD_CUSTOMER(qryName, qryStatusCd) {
        ...
        try {
            ...
            console.log(
                "KCD_CUSTOMER:",
                JSON.stringify(data.mgrKcdCustomerAllQuery.length),
            );
...
"payRule":argData.PAY_RULE
      ...
      `,
            ...
            console.log(
                "KCD_BUYER:",
                JSON.stringify(data.oneQueryKCD_BUYER.length),
            );
...
"remark":argData.REMARK
      ...
      `,
            ...
            console.log(
                "KCD_VENDOR:",
                JSON.stringify(data.oneQueryKCD_VENDOR.length),
            );
...
"packName":argData.PACK_NAME
      ...
      `,
            ...
            console.log(
                "KCD_FACTORY:",
                JSON.stringify(data.oneQueryKCD_FACTORY.length),
            );
...
"":argData.
      ...
      `,
            ...
            console.log(
                "KCD_PLACE:",
                JSON.stringify(data.oneQueryKCD_PLACE.length),
            );
