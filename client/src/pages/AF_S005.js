...
const AF_S001 = () => {
    ...
    const popup_INFO = (e) => {
        ...
        tObj.MEMS.forEach((col, i) => {
            var tObj = { ...col };
            tDataEmg.push(parseFloat(tObj.EMG));
            tDataEmgTime.push(parseFloat(tObj.EMG_TIME));
        ...
        <div className="af-div-main">
            <div style={{ height: "9rem" }}>
                ...
                >
                    ...
                    <span className="af-span-3-0" style={{ width: "21rem" }}>
                        <p className="af-span-p" style={{ width: "8rem" }}>EMG</p>
                        <div className="af-span-div" style={{ width: "12rem" }}>
                            <InputText
                                style={{ width: "12rem" }}
                                id="id_TARGET_ETA"
                                value={dataQRY_KSV_PO_MRP.EMG}
                                onChange={(e) =>
                                    onInputChangeQRY_KSV_PO_MRP(e, "EMG")
                                }
                            />
                        </div>
                    </span>
                    <span className="af-span-3-0" style={{ width: "21rem" }}>
                        <p className="af-span-p" style={{ width: "8rem" }}>근활성시간</p>
                        <div className="af-span-div" style={{ width: "12rem" }}>
                            <InputText
                                style={{ width: "12rem" }}
                                id="id_TARGET_ETA"
                                value={dataQRY_KSV_PO_MRP.EMG_TIME}
                                onChange={(e) =>
                                    onInputChangeQRY_KSV_PO_MRP(e, "EMG_TIME")
                                }
                            />
                        </div>
                    </span>
                    <span className="af-span-3-0" style={{ width: "21rem" }}>
                        <p className="af-span-p" style={{ width: "8rem" }}>운동횟수</p>
                        <div className="af-span-div" style={{ width: "12rem" }}>
                            <InputText
                                style={{ width: "12rem" }}
                                id="id_TARGET_ETA"
                                value={dataQRY_KSV_PO_MRP.CNT}
                                onChange={(e) =>
                                    onInputChangeQRY_KSV_PO_MRP(e, "CNT")
                                }
                            />
                        </div>
                    </span>
            ...
            >
                ...
                >
                    ...
                    <AFColumn field="EMG" headerClassName="t-header" header="EMG" className="af-col" style={{ width: "5rem" }} ></AFColumn>
                    <AFColumn field="EMG_TIME" headerClassName="t-header" header="근활성시간" className="af-col" style={{ width: "5rem" }} ></AFColumn>
                    <AFColumn field="CNT" headerClassName="t-header" header="운동횟수" className="af-col" style={{ width: "5rem" }} ></AFColumn>
                </AFDataTable>
            </div>
            <div
                className="af-div-first"
