...
const moduleMutation_S0511_5 = {
    Mutation: {
        mgrInsert_S0511_5: async (_, args, contextValue) => {
            // Move Stock
...
*/
        ...
        mgrInsert_S0511_5_1: async (_, args, contextValue) => {
            // End Proc
            var tDateNew = new Date();
            tDateNew.setMonth(tDateNew.getMonth() + 1);
            var tZeroDate = '00';
...
export default moduleMutation_S0511_5;
