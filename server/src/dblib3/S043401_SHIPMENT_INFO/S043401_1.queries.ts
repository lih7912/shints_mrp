...
const moduleQuery_S043401_1 = {
    Query: {
        mgrQueryS043401_1_CODE: async (_, args) => {
            var tWObj = {};
            ...
            tRet0.forEach((col, i) => {
                ...
                tObj.HS_NAMe = `${col.HS_CD}/${col.HS_NAME}`;
                tRet.push(tObj);
            });
            let tObj = {};
            tObj.HS_NO = '';
...
export default moduleQuery_S043401_1;
