...
const moduleQuery_S030302_COPY_STYLE_TBL_KSV_PROD_MST = {
    Query: {
        mgrQuery_S030302_COPY_STYLE_TBL_KSV_PROD_MST: async (_, args) => {
            var tSQL = '';
            if (args.KEY1 !== '') {
        ...
        mgrQuery_S030302_SEARCH_ORDER_MRP: async (_, args) => {
            var tSQL = '';
...
export default moduleQuery_S030302_COPY_STYLE_TBL_KSV_PROD_MST;
