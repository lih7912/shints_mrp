// MGR_S051801_1.typeDefs.js

// 데이터 형식(typeDefs) 지정하기 위한 gql 불러오기
import { gql } from 'apollo-server';

// export default 활용해 gql typeDefs 내보내기
const moduleTypedefs_S051801_1 = gql`
    type T_S051801_1 {
        PO_CD: String
        PO_SEQ: Int
        ORDER_CD: String
    ...
    input I_S051801_CODE {
        BUYER_CD: String
    }

    type T_S051801_1_CODE {
    ...
    type Query {
        mgrQueryS051801_1_CODE: T_S051801_1_CODE!
    }
`;

export default moduleTypedefs_S051801_1;
