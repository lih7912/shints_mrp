...
const moduleMutation_S0709_5 = {
    Mutation: {
        mgrInsert_S0709_5_INSERT_BILL: async (_, args, contextValue) => {
            ...
            for (tIdx = 0; tIdx < tInput2.length; tIdx++) {
                ...
                tInvoiceBill.pre_flag =
                    tInput1.PRE_FLAG.tInvoiceBill.status_cd = '0';
        ...
        mgrInsert_S0709_5_DELETE_BILL: async (_, args, contextValue) => {
            var tRetDate = AFLib.getCurrTime();
            var tRetDate1 = tRetDate.substring(0, 8);
            var tUserInfo = AFLib.getUserInfo(contextValue);
        ...
        mgrInsert_S0709_5_INSERT_DC: async (_, args, contextValue) => {
            var tRetDate = AFLib.getCurrTime();
            var tRetDate1 = tRetDate.substring(0, 8);
            var tUserInfo = AFLib.getUserInfo(contextValue);
            ...
            for (tIdx = 0; tIdx < tInput2.length; tIdx++) {
                ...
                if (tOne.CRDB_CD.substring(0, 1) === 'D') {
                    ...
                    if (parseFloat(tOne.CRDB_AMT) > 0) {
                        ...
                        tCrdbMem.reg_user = tIserInfo.USER_ID;
        ...
        mgrInsert_S0709_5_DELETE_DC: async (_, args, contextValue) => {
            var tRetDate = AFLib.getCurrTime();
            var tRetDate1 = tRetDate.substring(0, 8);
            var tUserInfo = AFLib.getUserInfo(contextValue);
...
export default moduleMutation_S0709_5;
