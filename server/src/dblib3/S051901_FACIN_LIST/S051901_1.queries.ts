...
const moduleQuery_S051901_1 = {
    Query: {
        mgrQueryS051901_1_CODE: async (_, args) => {
            var tWObj = {};
            let sqlStr = `
                select distinct
        ...
        mgrQueryS051901_1_CODE2: async (_, args) => {
            var tWObj = {};
        ...
        mgrQueryS051901_1: async (_, args) => {
            var tSQL = '';
...
export default moduleQuery_S051901_1;
