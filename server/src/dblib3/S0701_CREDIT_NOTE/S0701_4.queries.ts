...
const moduleQuery_S0701_4 = {
    Query: {
        mgrQueryS0701_4_REPORT: async (_, args, contextValue) => {
            ...
            for (tIdx = 0; tIdx < args.data.length; tIdx++) {
                ...
                var tWExcelFile = `CREDIT-${tOne.CRDB_CD}-${tRetDate}`;
                try {
                    // Excel Read
                    var tPath0 = '';
                    ...
                    sheet.getCell(2, 1).value = 'CREDIT NOTE';
...
export default moduleQuery_S0701_4;
