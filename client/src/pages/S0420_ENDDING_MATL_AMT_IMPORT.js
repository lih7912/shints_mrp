...
import { ServiceS0420_ENDDING_MATL_AMT_IMPORT } from "../service/service_biz/ServiceS0420_ENDDING_MATL_AMT_IMPORT";
...
const S0420_ENDDING_MATL_AMT_IMPORT = () => {
    ...
    const serviceS0420_ENDDING_MATL_AMT_IMPORT =
        new ServiceS0420_ENDDING_MATL_AMT_IMPORT();
    ...
    const searchTBL_KSV_STOCK_IN = () => {
        ...
        // serviceS0420_ENDDING_MATL_AMT_IMPORT.mgrQueryTBL_KSV_STOCK_IN(dataQRY_).then(data => {
        ...
        <div>
            ...
            >
                <AFDataTable preventUnrelatedRerender
                    ...
                    emptyMessage=" " //header={headerTBL_KSV_STOCK_IN}
                    responsiveLayout="scroll"
                    scrollable
                    scrollHeight="28rem"
                >
                    <AFColumn field="PO_CD" headerClassName="t-header" header="PO" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="BUYER" headerClassName="t-header" header="Buyer" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    ...
                    <AFColumn field="IN_QTY_TOT" headerClassName="t-header" header="In Qty(Tot)" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="IN_QTY_PAY" headerClassName="t-header" header="In Qty(Pay)" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="IN_CURR_CD" headerClassName="t-header" header="In Curr" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="IN_PRICE" headerClassName="t-header" header="In Price" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="PAY_CURR_CD" headerClassName="t-header" header="Pay Curr" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="PAY_PRICE" headerClassName="t-header" header="Pay Price" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="MATL_PRICE" headerClassName="t-header" header="Matl Price" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="TT_FLAG" headerClassName="t-header" header="T/T" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="WARE_NAME" headerClassName="t-header" header="Pur Factory" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="PAY_AMT" headerClassName="t-header" header="Pay Amt" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="END_FLAG" headerClassName="t-header" header="Close" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="END_DATE" headerClassName="t-header" header="Close Date" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="PAY_DATE" headerClassName="t-header" header="Pay Date" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="BILL_FLAG" headerClassName="t-header" header="Bill" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="BILL_DATE" headerClassName="t-header" header="Bill Date" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    ...
                    <AFColumn field="IN_DATETIME" headerClassName="t-header" header="In Date" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="MATL_SEQ" headerClassName="t-header" header="Matl Seq" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="CALC_FLAG" headerClassName="t-header" header="Calc Flag" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="VENDOR_CD" headerClassName="t-header" header="Vendor Cd" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="PUR_FACTORY" headerClassName="t-header" header="Pur Factory" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                    <AFColumn field="PAY_REPORT" headerClassName="t-header" header="Pay Report" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                </AFDataTable>
            </div>
...
export default React.memo(S0420_ENDDING_MATL_AMT_IMPORT, comparisonFn);
