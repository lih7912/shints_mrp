...
const moduleMutation_S0214_5 = {
    Mutation: {
        mgrUpdate_S0214_5_END: async (_, args, contextValue) => {
            //
...
*/
            ...
            for (tIdx0 = 0; tIdx0 < args.datas.length; tIdx0++) {
                ...
                if (col.ORDER_STATUS === '9') {
                    var tRetArray = [];
                    var tObj = {};
                    tObj.CODE = 'ERROR:Already End:' + col.ORDER_CD;
                    tObj.id = 0;
                    tRetArray.push(tObj);
                    return tRetArray;
                }
...
export default moduleMutation_S0214_5;
