...
const moduleMutation_S030602_MRP_BY_ORDER_STYLE_EDT_KSV_PROD_MEM = {
    Mutation: {
        mgrInsert_S030602_MRP_BY_ORDER_STYLE_EDT_KSV_PROD_MEM: async (
            _,
            args,
            contextValue,
        ) => {
            const tProdCd = args.data?.PROD_CD || args.datas?.[0]?.PROD_CD;
            const tOrderCd = args.data?.ORDER_CD || args.datas?.[0]?.ORDER_CD;
            const tOrderMrpSeq =
                args.data?.ORDER_MRP_SEQ || args.datas?.[0]?.ORDER_MRP_SEQ;

            if (!tProdCd || !tOrderCd || !tOrderMrpSeq) {
                return [
                    {
                        id: 0,
                        CODE: 'ERROR: Missing PROD_CD/ORDER_CD/ORDER_MRP_SEQ.',
                    },
                ];
            }
...
*/
        ...
        mgrUpdate_S030602_MRP_BY_ORDER_STYLE_EDT_KSV_PROD_MEM: async (
            _,
            args,
        ) => {
            //
...
*/
        ...
        mgrDelete_S030602_MRP_BY_ORDER_STYLE_EDT_KSV_PROD_MEM: async (
            _,
            args,
        ) => {
            //
...
export default moduleMutation_S030602_MRP_BY_ORDER_STYLE_EDT_KSV_PROD_MEM;
