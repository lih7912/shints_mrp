...
const moduleQuery_S0406_3 = {
    Query: {
        mgrQueryS0406_3_1: async (_, args) => {
            var tSQL = '';
        ...
        mgrQueryS0406_3_2: async (_, args) => {
            var tSQL = '';
            if (args.data.STYLE_CD !== '') {
                tSQL += `AND STYLE_NAME like '%${args.data.STYLE_CD}%' `;
            }
...
export default moduleQuery_S0406_3;
