...
const moduleQuery_S0801_4_CRDB = {
    Query: {
        mgrQueryS0801_4_CRDB_REPORT: async (_, args, contextValue) => {
        ...
        mgrQueryS0801_4_CRDB: async (_, args) => {
            var tSQL = '';
            ...
            let sqlStr = `
                ...
                WHERE
                    ...
                    AND isnull(G.INVOICE_NO, 'non-crdb') = 'non-crdb'
                GROUP BY
                    A.CRDB_CD,
                    A.CRDB_SEQ,
                    A.CRDB_DATE,
        ...
        mgrQueryS0801_4_CRDB_1: async (_, args) => {
            var tSQL = '';
        ...
        mgrQueryS0801_4_CRDB_REPORT_bak1: async (_, args, contextValue) => {
            var tRetDate = AFLib.getCurrTime();
            var tRetDate1 = tRetDate.substring(0, 8);
            var tUserInfo = AFLib.getUserInfo(contextValue);
            var tInput = { ...args };
...
export default moduleQuery_S0801_4_CRDB;
