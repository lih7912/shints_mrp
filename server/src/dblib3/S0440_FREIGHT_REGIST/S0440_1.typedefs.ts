// MGR_S0440_1.typeDefs.js

// 데이터 형식(typeDefs) 지정하기 위한 gql 불러오기
import { gql } from 'apollo-server';

// export default 활용해 gql typeDefs 내보내기
const moduleTypedefs_S0440_1 = gql`
    type T_S0440_1 {
        PO_CD: String
        PO_SEQ: Int
        ORDER_CD: String
    ...
    type T_S0440_1_CODE {
        ...
        ORIGIN: [BASE_QRY_KCD_CODE!]!
        DESTINATION: [BASE_QRY_KCD_CODE!]!
        PAYMENT: [BASE_QRY_KCD_CODE!]!
    ...
    type Query {
        mgrQueryS0440_1_CODE: T_S0440_1_CODE!
    }
`;

export default moduleTypedefs_S0440_1;
