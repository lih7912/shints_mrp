...
const moduleQuery_S0702_4 = {
    Query: {
        mgrQueryS0702_4_REPORT: async (_, args, contextValue) => {
            ...
            for (tIdx = 0; tIdx < args.data.length; tIdx++) {
                ...
                var tWExcelFile = `DEBIT-${tOne.CRDB_CD}-${tRetDate}`;
                try {
                    // Excel Read
                    var tPath0 = '';
                    ...
                    if (tTitle !== '') {
                        ...
                        for (tIdx1 = 0; tIdx1 < tRet4.length; tIdx1++) {
                            ...
                            */
                            ...
                            sheet.getCell(20 + tIdx1, 4).value = tOne1.style_name;
                            sheet.getCell(20 + tIdx1, 5).value = tOne1.invoice_no;
                            sheet.getCell(20 + tIdx1, 6).value = tOne1.ship_date;
                            ...
                            var tShipCnt = 0;
                            if (tRet5.length > 0) {
                                sheet.getCell(20 + tIdx1, 7).value = tRet5[0].Expr1;
                            ...
                            sheet.getCell(21 + tIdx1, 3).value = tOne1.style_name;
                            sheet.getCell(21 + tIdx1, 7).value = tOne1.invoice_no;
                            sheet.getCell(21 + tIdx1, 8).value = tOne1.ship_date;
                            sheet.getCell(21 + tIdx1, 9).value = tShipCnt;
                            sheet.getCell(21 + tIdx1, 12).value = tOne1.fc_price;
                        ...
                        if (tCrdbObj.messer_cd.length === 2) {
                            ...
                            if (tRet6.length > 0) {
                                ...
                                sheet.getCell(16, 4).value = tRet6[0].account_no;
                                sheet.getCell(17, 4).value = tRet6[0].account_name;
                        ...
                        sheet.getCell(14, 4).value = `INDUSTRIAL BANK OF KOREA, GURO DIGITAL BRANCH`;
                        sheet.getCell(15, 4).value = `1F, ACE Techno Tower II, 19, DIGITAL-RO 31-GIL, GURO-GU, SEOUL, KOREA`;
                        sheet.getCell(16, 4).value = `420-035642-56-00016`;
                        sheet.getCell(17, 4).value = `SHIN TEXTILE SOLUTIONS CO.,LTD.`;
                        sheet.getCell(18, 4).value = `IBKOKRSEXXX`;
                    } else {
                        if (tCrdbObj.messer_cd.length === 2) {
                            // Buyer
                            let sql6 = `
                            ...
                            if (tRet6.length > 0) {
                                ...
                                sheet.getCell(20, 4).value = tRet6[0].account_no;
                                sheet.getCell(21, 4).value = tRet6[0].account_name;
                        ...
                        //INDUSTRIAL BANK OF KOREA, GURO DIGITAL BRANCH
                        if (tCrdbObj.bank_cd === '9') { 
                            sheet.getCell(18, 2).value = `• Bank details`;
                            sheet.getCell(20, 2).value = `• Account no`;
                            sheet.getCell(21, 2).value = `• Account name`;
                            sheet.getCell(22, 2).value = `• Swift code`;
                            sheet.getCell(18, 2).font = { size: 12, name: 'Dotum' };
                            sheet.getCell(20, 2).font = { size: 12, name: 'Dotum' };
                            sheet.getCell(21, 2).font = { size: 12, name: 'Dotum' };
                            sheet.getCell(22, 2).font = { size: 12, name: 'Dotum' };

                            sheet.getCell(18, 4).value = `INDUSTRIAL BANK OF KOREA, GURO DIGITAL BRANCH`;
                            sheet.getCell(19, 4).value = `1F, ACE Techno Tower II, 19, DIGITAL-RO 31-GIL, GURO-GU, SEOUL, KOREA`;
                            sheet.getCell(20, 4).value = `420-035642-56-00016`;
                            sheet.getCell(21, 4).value = `SHIN TEXTILE SOLUTIONS CO.,LTD.`;
                            sheet.getCell(22, 4).value = `IBKOKRSEXXX`;
                        }
                    }
...
export default moduleQuery_S0702_4;
