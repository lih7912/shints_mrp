...
import { ServiceS0407_STSIN_DEPOSIT_LC } from "../service/service_biz/ServiceS0407_STSIN_DEPOSIT_LC";
...
const S0407_STSIN_DEPOSIT_LC = () => {
    ...
    const serviceS0407_STSIN_DEPOSIT_LCRef = useRef(null);
    if (!serviceS0407_STSIN_DEPOSIT_LCRef.current) serviceS0407_STSIN_DEPOSIT_LCRef.current = new ServiceS0407_STSIN_DEPOSIT_LC();
    const serviceS0407_STSIN_DEPOSIT_LC = serviceS0407_STSIN_DEPOSIT_LCRef.current;
    ...
    const searchPO_CD = () => {
        ...
        serviceS0407_STSIN_DEPOSIT_LC.mgrQuery_PO_CD(tObj).then((data) => {
    ...
    const onInputChangeQRY_KSV_STOCK_IN1_T_QTY = (e, name) => {
        let val = (e.target && e.target.value) || "";
    ...
    const [
        datasQRY_KSV_STOCK_IN1_BILL_TYPE,
        setDatasQRY_KSV_STOCK_IN1_BILL_TYPE,
    ] = useState([]);
    const [
        dataQRY_KSV_STOCK_IN1_BILL_TYPE,
        setDataQRY_KSV_STOCK_IN1_BILL_TYPE,
    ] = useState({});

    const onDropdownChangeQRY_KSV_STOCK_IN1_BILL_TYPE = (e, name) => {
        ...
        setDataQRY_KSV_STOCK_IN1(_dataQRY_KSV_STOCK_IN1);
        setDataQRY_KSV_STOCK_IN1_BILL_TYPE(e.value);
    };
    ...
    const onRowClick1TBL_KCD_VENDOR = (argData0) => {
        ...
        serviceS0407_STSIN_DEPOSIT_LC
            .mgrQuery_STOCK_IN_PRE(tObj0)
            .then((data) => {
                if (typeof data.graphQLErrors === "undefined") {
        ...
        tObj1.MATL_CD = "";
        serviceS0407_STSIN_DEPOSIT_LC
            .mgrQuery_STOCK_IN_WORK(tObj1)
            .then((data) => {
                if (typeof data.graphQLErrors === "undefined") {
                    console.log(
                        "mgrQuery_STOCK_IN_WORK call => " + data.length,
                    );
                    var tSumQty = 0;
                    var tSumRemain = 0;
    ...
    const searchTBL_KSV_PO_MRP1 = () => {
        ...
        // serviceS0407_STSIN_DEPOSIT_LC.mgrQueryTBL_KSV_PO_MRP1(dataQRY_KSV_PO_MRP1).then(data => {
        //     if (typeof data.graphQLErrors === 'undefined') {
    ...
    const onRowClick1TBL_KSV_PO_MST1 = (argData0) => {
        ...
        serviceS0407_STSIN_DEPOSIT_LC.mgrQuery_VENDOR_CD(tObj0).then((data) => {
            if (typeof data.graphQLErrors === "undefined") {
                console.log("mgrQuery_PO_CD call => " + data.length);
                setDatasTBL_KCD_VENDOR(data);
                setDatasTBL_KSV_PO_MRP([]);
    ...
    const searchTBL_KSV_PO_MST1 = () => {
        ...
        // serviceS0407_STSIN_DEPOSIT_LC.mgrQueryTBL_KSV_PO_MST1(dataQRY_KSV_PO_MST1).then(data => {
        //     if (typeof data.graphQLErrors === 'undefined') {
            ...
            <div style={{ width: "20rem", float: "left", height: "4rem" }}>
                ...
                >
                    <AFDataTable preventUnrelatedRerender
                        ...
                        scrollHeight="18rem"
                    >
                        <AFColumn field="PO_CD" headerClassName="t-header" header="Pp No" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    </AFDataTable>
                </div>
            ...
            <div style={{ width: "75rem", float: "left" }}>
                ...
                >
                    ...
                    >
                        ...
                        <AFColumn field="P_STATUS" headerClassName="t-header" header="P Status" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                        <AFColumn field="CONF_FLAG" headerClassName="t-header" header="st" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                        <AFColumn field="CURR_CD" headerClassName="t-header" header="curr cd" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                        <AFColumn field="TEMP_PRICE" headerClassName="t-header" header="temp price" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    </AFDataTable>
                </div>
                <div
                    style={{
                ...
                >
                    ...
                    >
                        <p style={{ width: "8rem", display: "inline-block" }}>Total</p>
                        <InputText
                            style={{
                                marginLeft: "0.5rem",
                                display: "inline-block",
                            ...
                            id="id_T_QTY"
                            value={dataQRY_KSV_STOCK_IN1.T_QTY}
                            onChange={(e) =>
                                onInputChangeQRY_KSV_STOCK_IN1_T_QTY(e, "T_QTY")
                            }
                            disabled
                        />
                    </span>
                    ...
                    >
                        <p style={{ width: "5rem", display: "inline-block" }}>Pay Date</p>
                        <div
                            style={{
                                marginLeft: "0.5rem",
                                display: "inline-block",
                    ...
                    >
                        <p style={{ width: "8rem", display: "inline-block" }}>Bill Type</p>
                        <div
                            style={{
                                marginLeft: "0.5rem",
                                display: "inline-block",
                        ...
                        >
                            <Dropdown
                                id="id_BILL_TYPE"
                                value={dataQRY_KSV_STOCK_IN1_BILL_TYPE}
                                onChange={(e) =>
                                    onDropdownChangeQRY_KSV_STOCK_IN1_BILL_TYPE(
                                        e,
                                        "BILL_TYPE",
                                    )
                                }
                                options={datasQRY_KSV_STOCK_IN1_BILL_TYPE}
                                optionLabel="CD_NAME"
                                placeholder=""
                                editable
                            ></Dropdown>
                    ...
                    <span style={{ marginLeft: "42rem", marginTop: "0.5rem" }}>
                        <Tooltip
                        ...
                        <Button
                            ...
                            icon="pi pi-upload"
                            className="p-button-text"
                            onClick={exportExcelTBL_KSV_PO_MRP1}
                        />
                    </span>
                </div>
                ...
                >
                    ...
                    >
                        ...
                        <AFColumn field="SPEC" headerClassName="t-header" eader="Spec" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
                        ...
                        <AFColumn field="BEF_QTY" headerClassName="t-header" header="In Qty(Bef)" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem" }} ></AFColumn>
...
export default React.memo(S0407_STSIN_DEPOSIT_LC, comparisonFn);
