...
const moduleQuery_S043101_1 = {
    Query: {
        mgrQueryS043101_1_CODE: async (_, args) => {
            var tWObj = {};
            let sqlStr = `
                select distinct
        ...
        mgrQueryS043101_1_CODE2: async (_, args) => {
            var tWObj = {};
        ...
        mgrQueryS043101_1: async (_, args) => {
            var tSQL = '';
...
export default moduleQuery_S043101_1;
