...
const moduleQuery_S030513_1 = {
    Query: {
        mgrQueryS030513_1: async (_, args) => {
            var tSQL = '';
                ...
                where
                    a.order_cd in (
                        ...
                        from
                            ksv_po_mem
                        where
                            po_cd like '%${args.data.PO_CD.split(' ').join('%')}%'
                    )
        ...
        mgrQueryS030513_1_CODE: async (_, args) => {
            var tWObj = {};
            let sqlStr = `
                select
                    PO_CD,
...
export default moduleQuery_S030513_1;
