...
const moduleQuery_S0703_1 = {
    Query: {
        mgrQueryS0703_CODE1: async (_, args) => {
            var tWObj = {};
        ...
        mgrQueryS0703_CODE: async (_, args) => {
            var tWObj = {};
            tWObj.FACTORY = [];
            tWObj.MESSER = [];
            tWObj.BUYER3 = [];
...
export default moduleQuery_S0703_1;
