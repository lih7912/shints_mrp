...
const AF_S001 = () => {
    ...
    const popup_INFO = (e) => {
        ...
        tObj.MEMS.forEach((col, i) => {
            var tObj = { ...col };
            tObj.TIME = `${col.TIME}분`;
            tObj.TEMP = `${col.TEMP}도`;
            tDataTemp.push(parseFloat(tObj.TEMP));
            tDataECG.push(parseFloat(tObj.ECG));
        ...
        <div className="af-div-main">
            <div style={{ height: "9rem" }}>
                ...
                >
                    ...
                    <span className="af-span-3-0" style={{ width: "21rem" }}>
                        <p className="af-span-p" style={{ width: "8rem" }}>Temp</p>
                        <div className="af-span-div" style={{ width: "12rem" }}>
                            <InputText
                                style={{ width: "12rem" }}
                                id="id_TARGET_ETA"
                                value={dataQRY_KSV_PO_MRP.TEMP}
                                onChange={(e) =>
                                    onInputChangeQRY_KSV_PO_MRP(e, "TEMP")
                                }
                            />
                        </div>
                    </span>
                    ...
                    <span className="af-span-3-0" style={{ width: "21rem" }}>
                        <p className="af-span-p" style={{ width: "8rem" }}>Result</p>
                        <div className="af-span-div" style={{ width: "12rem" }}>
                            <InputText
                                style={{ width: "12rem" }}
                                id="id_TARGET_ETA"
                                value={dataQRY_KSV_PO_MRP.RESULT}
                                onChange={(e) =>
                                    onInputChangeQRY_KSV_PO_MRP(e, "RESULT")
                                }
                            />
                        </div>
                    </span>
            ...
            >
                ...
                >
                    ...
                    <AFColumn field="TIME" headerClassName="t-header" header="Time" className="af-col" style={{ width: "5rem" }} ></AFColumn>
                    <AFColumn field="TEMP" headerClassName="t-header" header="Temp" className="af-col" style={{ width: "5rem" }} ></AFColumn>
                    <AFColumn field="ECG" headerClassName="t-header" header="ECG" className="af-col" style={{ width: "5rem" }} ></AFColumn>
                    <AFColumn field="RESULT" headerClassName="t-header" header="Result" className="af-col" style={{ width: "5rem" }} ></AFColumn>
                </AFDataTable>
            </div>
            <div
                className="af-div-first"
