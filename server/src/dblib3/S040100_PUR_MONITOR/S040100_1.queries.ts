...
const moduleQuery_S040100_1 = {
    Query: {
        mgrQueryS040100_1_CODE: async (_, args) => {
            var tWObj = {};
            let sqlStr = `
                select distinct
        ...
        mgrQueryS040100_1_CODE3: async (_, args) => {
            var tWObj = {};
        ...
        mgrQueryS040100_1_CODE2: async (_, args) => {
            var tWObj = {};
            ...
            let tArray = ['', 'SHINTS', 'BUYER', 'FACTORY', 'BVT', 'ETP'];
            let tArray1 = [' ', 'SHINTS', 'BUYER', 'FACTORY', 'BVT', 'ETP'];
            let tRet = tArray.map((col, i) => {
                var tObj = {};
                tObj.id = i;
                tObj.CD_CODE = col;
...
*/
        ...
        mgrQueryS040100_1: async (_, args) => {
            var tSQL = '';
...
export default moduleQuery_S040100_1;
