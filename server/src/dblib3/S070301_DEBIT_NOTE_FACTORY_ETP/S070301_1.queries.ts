...
const moduleQuery_S070301_1 = {
    Query: {
        mgrQueryS070301_CODE1: async (_, args) => {
            var tWObj = {};
        ...
        mgrQueryS070301_CODE: async (_, args) => {
            var tWObj = {};
            tWObj.FACTORY = [];
            tWObj.MESSER = [];
            tWObj.BUYER3 = [];
...
*/
        ...
        mgrQueryS070301_1: async (_, args) => {
            let sqlStr = `
                SELECT DISTINCT
                    A.PO_CD
                FROM
...
export default moduleQuery_S070301_1;
