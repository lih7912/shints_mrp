...
const moduleMutation_S030302_COPY_STYLE_EDT_KSV_PROD_MEM = {
    Mutation: {
        mgrInsert_S030302_COPY_STYLE_EDT_KSV_PROD_MEM: async (
            _,
            args,
            contextValue,
        ) => {
            ...
            if (!tProdCd) {
                return [{ id: 0, CODE: 'ERROR: Missing PROD_CD.' }];
            }
...
*/
        ...
        mgrUpdate_S030302_COPY_STYLE_EDT_KSV_PROD_MEM: async (_, args) => {
            //
            var tDate = new Date();
            var mm = tDate.getMonth() + 1;
            var mm_str = '';
...
*/
        ...
        mgrDelete_S030302_COPY_STYLE_EDT_KSV_PROD_MEM: async (_, args) => {
            //
            var tDate = new Date();
            var mm = tDate.getMonth() + 1;
            var mm_str = '';
...
export default moduleMutation_S030302_COPY_STYLE_EDT_KSV_PROD_MEM;
