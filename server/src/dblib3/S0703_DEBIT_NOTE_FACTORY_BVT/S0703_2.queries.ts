...
const moduleQuery_S0703_2 = {
    Query: {
        mgrQueryS0703_2: async (_, args, contextValue) => {
            ...
            var sqlStr = `
                ...
                FROM
                    ...
                    LEFT JOIN KCD_BUYER J ON B.BUYER_CD = J.BUYER_CD
                    LEFT JOIN KCD_CODE I ON J.BUYER_TEAM = I.CD_CODE
        ...
        mgrQueryS0703_2_BY_NUMBER: async (_, args, contextValue) => {
            var tRetDate = AFLib.getCurrTime();
            var tRetDate1 = tRetDate.substring(0, 8);
            var tUserInfo = AFLib.getUserInfo(contextValue);
        ...
        mgrQueryS0703_2_1: async (_, args) => {
            var tSQL = '';
        ...
        mgrQueryS0703_2_bak: async (_, args, contextValue) => {
            var tRetDate = AFLib.getCurrTime();
            var tRetDate1 = tRetDate.substring(0, 8);
            var tUserInfo = AFLib.getUserInfo(contextValue);
...
export default moduleQuery_S0703_2;
