// MGR_S0430_1.typeDefs.js

// 데이터 형식(typeDefs) 지정하기 위한 gql 불러오기
import { gql } from 'apollo-server';

// export default 활용해 gql typeDefs 내보내기
const moduleTypedefs_S0430_1 = gql`
    type T_S0430_1 {
        PO_CD: String
        PO_SEQ: Int
        ORDER_CD: String
    ...
    type Query {
        mgrQueryS0430_1(data: I_S0430_1!): [T_S0430_1!]!
        mgrQueryS0430_1_CODE: T_S0430_1_CODE!
        mgrQueryS0430_1_CODE2(data: I_S0430_CODE!): T_S0430_1_CODE2!
    }
`;

export default moduleTypedefs_S0430_1;
