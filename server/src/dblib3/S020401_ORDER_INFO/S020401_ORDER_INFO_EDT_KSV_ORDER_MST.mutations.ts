...
const moduleMutation_S020401_ORDER_INFO_EDT_KSV_ORDER_MST = {
    Mutation: {
        mgrInsert_S020401_ORDER_INFO_EDT_KSV_ORDER_MST: async (_, args) => {
            //
            var tDate = new Date();
...
*/
            ...
            for (tIdx = 0; tIdx < args.datas.length; tIdx++) {
                ...
                delete tObjEDT_KSV_ORDER_MST.id;

                /*
        let retInsert = await prisma.EDT_KSV_ORDER_MST.create({data:tObj@@TNAME@@});
...
*/
        ...
        mgrUpdate_S020401_ORDER_INFO_EDT_KSV_ORDER_MST: async (_, args) => {
            //
            var tDate = new Date();
            var mm = tDate.getMonth() + 1;
            var mm_str = '';
...
*/
        ...
        mgrDelete_S020401_ORDER_INFO_EDT_KSV_ORDER_MST: async (_, args) => {
            //
            var tDate = new Date();
            var mm = tDate.getMonth() + 1;
            var mm_str = '';
...
export default moduleMutation_S020401_ORDER_INFO_EDT_KSV_ORDER_MST;
