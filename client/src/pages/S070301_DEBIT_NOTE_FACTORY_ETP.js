...
import { ServiceS070301_DEBIT_NOTE_FACTORY_ETP } from "../service/service_biz/ServiceS070301_DEBIT_NOTE_FACTORY_ETP";
...
const S070301_DEBIT_NOTE_FACTORY_ETP = () => {
    ...
    const serviceS070301_DEBIT_NOTE_FACTORY_ETP =
        new ServiceS070301_DEBIT_NOTE_FACTORY_ETP();
    ...
    const process_INSERT_DEBIT_NOTE_FACTORY_ETP = () => {
        ...
        serviceS070301_DEBIT_NOTE_FACTORY_ETP
            .mgrUpdate_INSERT_DEBIT_NOTE_FACTORY_ETP(tObj)
            .then((data) => {
                    ...
                    if (data.length > 0) {
                        ...
                        if (data[0].CODE.includes("SUCC")) {
                            ...
                            if (tCols.length >= 3) {
                                ...
                                tObj2.PO_CD = "";
                                tObj2.ORDER_CD = "";
                                setDataEDT_KSV_INVOICE_MST1(tObj2);
    ...
    const process_CANCEL_DEBIT_NOTE_FACTORY_ETP = () => {
        var tObj = { ...dataEDT_KSV_INVOICE_MST1 };
        ...
        setLoadingTBL_KSV_INVOICE_MST(true);
        serviceS070301_DEBIT_NOTE_FACTORY_ETP
            .mgrUpdate_CANCEL_DEBIT_NOTE_FACTORY_ETP(tObj)
            .then((data) => {
                setLoadingTBL_KSV_INVOICE_MST(false);
                if (typeof data.graphQLErrors === "undefined") {
                    // console.log("ServiceMgrKCD_BUYER.mgr1KcdStyle call => " + data.length);
    ...
    const process_UPDATE_DEBIT_NOTE_FACTORY_ETP = () => {
        var tObj = { ...dataEDT_KSV_INVOICE_MST1 };
        if (tObj.DEBIT_NO === "") {
        ...
        setLoadingTBL_KSV_INVOICE_MST(true);
        serviceS070301_DEBIT_NOTE_FACTORY_ETP
            .mgrUpdate_UPDATE_DEBIT_NOTE_FACTORY_ETP(tObj)
            .then((data) => {
                setLoadingTBL_KSV_INVOICE_MST(false);
                if (typeof data.graphQLErrors === "undefined") {
                    // console.log("ServiceMgrKCD_BUYER.mgr1KcdStyle call => " + data.length);
    ...
    const process_CONFIRM_DEBIT_NOTE_FACTORY_ETP = () => {
    ...
    const process_END_DEBIT_NOTE_FACTORY_ETP = () => {
        var tObj = { ...dataEDT_KSV_INVOICE_MST1 };
        var tUserInfo = serviceLib.getUserInfo();
        tObj.USER_ID = tUserInfo.USER_ID;
        ...
        setLoadingTBL_KSV_INVOICE_MST(true);
        serviceS070301_DEBIT_NOTE_FACTORY_ETP
            .mgrUpdate_END_DEBIT_NOTE_FACTORY_ETP(tObj, tObj1, selectedItem)
            .then((data) => {
                setLoadingTBL_KSV_INVOICE_MST(false);
                if (typeof data.graphQLErrors === "undefined") {
                    // console.log("ServiceMgrKCD_BUYER.mgr1KcdStyle call => " + data.length);
    ...
    const GW_WINDOW_NAME = "GW_DEBIT_ETP_POPUP";
            ...
            .then((data) => {
                ...
                if (typeof data.graphQLErrors === "undefined") {
                    ...
                    var tArray = data.map((col, i) => {
                        ...
                        if (tObj.CONF_USER === "undefined") tObj.CONF_USER = "";
                        return tObj;
                    });
    ...
    const exportExcelTBL_KSV_INVOICE_MST = () => {
        ...
        datasTBL_KSV_INVOICE_MST.forEach((col, i) => {
            ...
            if (!col.USD_BAL)  tObj.Usd_Bal = 0;
            else tObj.Usd_Bal = Number(col.USD_BAL);
    ...
    const resetEDT_KSV_INVOICE_MST1 = () => {
        ...
        editEDT_KSV_INVOICE_MST1_PAY_CURR_CD("USD");
        editEDT_KSV_INVOICE_MST1_STATUS_CD("0");
        editEDT_KSV_INVOICE_MST1_LINK_TO("");
        editEDT_KSV_INVOICE_MST1_DEBIT_TYPE("1");
    ...
    useEffect(() => {
        ...
        if (tPoCd !== "") {
            ...
            tSaveObj = JSON.parse(
                window.localStorage.getItem("S070301_DEBIT_NOTE_FACTORY_ETP"),
            );
        ...
        <div className="af-div-main">
                ...
                <span className="af-span-3" style={{ width: "9rem" }}>
                    <div className="af-span-div-btn" style={{ width: "8rem" }}>
                        <Button
                            ...
                            label="End"
                            className="p-button-text"
                            onClick={process_END_DEBIT_NOTE_FACTORY_ETP}
                        />
                    </div>
                </span>
                <span className="af-span-3" style={{ width: "9rem" }}>
            ...
            >
                ...
                >
                    ...
                    <AFColumn field="CONF_FLAG" headerClassName="t-header" header="Confirm" style={{ width: "10rem", height: "1.8rem", flexBasis: "auto", }} bodyStyle={{ textAlign: "center" }} body={(rowData) => rowData.CONF_FLAG === "Y" && String(rowData.CONF_USER || "").trim() !== "" ? <i className="pi pi-check" style={{ color: "green" }}></i> : null} ></AFColumn>
                    <AFColumn field="CREDIT_STATUS" headerClassName="t-header" header="Status" style={{ width: "6rem", height: "1.8rem", flexBasis: "auto", }} ></AFColumn>
                ...
                <span className="af-span-3" style={{ width: "11rem" }}>
                    <div className="af-span-div-btn" style={{ width: "10rem" }}>
                        <Button
                            ...
                            label="Insert"
                            className="p-button-text"
                            onClick={process_INSERT_DEBIT_NOTE_FACTORY_ETP}
                        />
                    </div>
                </span>
                <span className="af-span-3" style={{ width: "11rem" }}>
                    <div className="af-span-div-btn" style={{ width: "10rem" }}>
                        <Button
                            ...
                            label="Update"
                            className="p-button-text"
                            onClick={process_UPDATE_DEBIT_NOTE_FACTORY_ETP}
                        />
                    </div>
                </span>
                <span className="af-span-3" style={{ width: "11rem" }}>
                    <div className="af-span-div-btn" style={{ width: "10rem" }}>
                        <Button
                            ...
                            label="Cancel"
                            className="p-button-text"
                            onClick={process_CANCEL_DEBIT_NOTE_FACTORY_ETP}
                        />
                    </div>
                </span>
                <span className="af-span-3" style={{ width: "11rem" }}>
                    <div className="af-span-div-btn" style={{ width: "10rem" }}>
                        <Button
                            ...
                            label="Confirm"
                            className="p-button-text"
                            onClick={process_CONFIRM_DEBIT_NOTE_FACTORY_ETP}
                        />
                    </div>
                </span>
                <span className="af-span-3" style={{ width: "11rem" }}>
...
export default React.memo(S070301_DEBIT_NOTE_FACTORY_ETP, comparisonFn);
