...
CREATE PROCEDURE [dbo].[kspPoMatlListAdjustNoSeq]
	@strPoCd	varchar(10),
...
DECLARE kspPoMatlListAdjust_C1 CURSOR FOR
SELECT  b.vendor_cd, a.matl_cd, '1',D.VENDOR_name, B.MATL_NAME, b.color, b.spec
FROM KSV_PO_MRP AS A INNER JOIN 
	KCD_MATL_MST AS B ON A.MATL_CD = B.MATL_CD INNER JOIN  
	KCD_MATL_MEM AS C ON B.MATL_CD = C.MATL_CD INNER JOIN 
...
SELECT  d.vendor_cd, a.matl_cd, '1',D.VENDOR_name, B.MATL_NAME, b.color, b.spec ,sum(USE_QTY)
FROM KSV_PO_MRP AS A INNER JOIN 
	KCD_MATL_MST AS B ON A.MATL_CD = B.MATL_CD INNER JOIN  
	KCD_MATL_MEM AS C ON B.MATL_CD = C.MATL_CD INNER JOIN 
	KCD_VENDOR AS D ON b.VENDOR_CD = D.VENDOR_CD 
WHERE (a.PO_CD = @strPoCd) AND (a.po_seq > 100) AND (a.use_po_type = '1') and b.matl_type <> 'Z'
GROUP BY D.VENDOR_CD, A.MATL_CD, D.VENDOR_name, B.MATL_NAME, b.color, b.spec
ORDER BY D.VENDOR_name, B.MATL_NAME, b.color, b.spec
...
SELECT  d.vendor_cd, a.matl_cd, '1',D.VENDOR_name, B.MATL_NAME, b.color, b.spec ,sum(USE_QTY),a.order_cd 
FROM KSV_PO_MRP AS A INNER JOIN 
	KCD_MATL_MST AS B ON A.MATL_CD = B.MATL_CD INNER JOIN  
...
GROUP BY D.VENDOR_CD, A.MATL_CD, D.VENDOR_name, B.MATL_NAME, b.color, b.spec,a.order_cd 
ORDER BY D.VENDOR_name, B.MATL_NAME, b.color, b.spec
