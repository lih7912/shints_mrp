...
const moduleQuery_S0430_1 = {
    Query: {
        mgrQueryS0430_1_CODE: async (_, args) => {
            var tWObj = {};
            let sqlStr = `
                select distinct
                ...
                where
                    a.po_status in ('4')
                    and a.yy in (2022, 2023, 2024, 2025, 2026)
        ...
        mgrQueryS0430_1_CODE2: async (_, args) => {
            var tWObj = {};
...
export default moduleQuery_S0430_1;
