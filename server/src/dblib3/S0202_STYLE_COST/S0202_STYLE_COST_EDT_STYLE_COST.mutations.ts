...
const moduleMutation_S0202_STYLE_COST_EDT_STYLE_COST = {
    Mutation: {
        mgrInsert_S0202_STYLE_COST_EDT_STYLE_COST: async (_, args) => {
            //
            var tDate = new Date();
...
*/
            ...
            for (tIdx = 0; tIdx < args.datas.length; tIdx++) {
                ...
                var tObjEDT_STYLE_COST = { ...tData };
                delete tObjEDT_STYLE_COST.id;

                /*
        let retInsert = await prisma.EDT_STYLE_COST.create({data:tObj@@TNAME@@});
...
*/
        ...
        mgrUpdate_S0202_STYLE_COST_EDT_STYLE_COST: async (_, args) => {
            //
            var tDate = new Date();
            var mm = tDate.getMonth() + 1;
            var mm_str = '';
...
*/
        ...
        mgrDelete_S0202_STYLE_COST_EDT_STYLE_COST: async (_, args) => {
            //
            var tDate = new Date();
            var mm = tDate.getMonth() + 1;
            var mm_str = '';
...
export default moduleMutation_S0202_STYLE_COST_EDT_STYLE_COST;
