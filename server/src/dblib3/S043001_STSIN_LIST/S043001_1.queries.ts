...
const moduleQuery_S043001_1 = {
    Query: {
        mgrQueryS043001_1_CODE: async (_, args) => {
            var tWObj = {};
        ...
        mgrQueryS043001_1_CODE2: async (_, args) => {
            var tWObj = {};
        ...
        mgrQueryS043001_1: async (_, args) => {
            var tSQL = '';
...
export default moduleQuery_S043001_1;
