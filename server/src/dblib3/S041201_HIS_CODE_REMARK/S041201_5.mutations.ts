...
const moduleMutation_S041201_5 = {
    Mutation: {
        mgrInsert_S041201_5: async (_, args, contextValue) => {
            //
...
*/
            ...
            let tSQL99 = `
                UPDATE KCD_MATL_MST
                SET
                    permit_compo1 = '${tInput.COMBO1}',
                    permit_compo2 = '${tInput.COMBO2}',
                    permit_compo3 = '${tInput.COMBO3}',
                    permit_detail = '${tInput.DETAIL}',
                    hs_cd = '${tInput.HS_CODE}'
                WHERE
            ...
            try {
                ...
                var tRetArray = [];
                var tObj = {};
                tObj.CODE = 'ERROR:Update HS_CODE SQL Error';
                tObj.id = 0;
                tRetArray.push(tObj);
                return tRetArray;
            }
            ...
            var tRetArray = [];
            var tObj = {};
            tObj.CODE = 'SUCCEED:Update HS_CODEt:' + args.datas.length;
            tObj.id = 0;
            tRetArray.push(tObj);
...
export default moduleMutation_S041201_5;
