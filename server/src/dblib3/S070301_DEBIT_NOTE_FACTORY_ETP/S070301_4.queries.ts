...
const moduleQuery_S070301_4 = {
    Query: {
        mgrQueryS070301_4_REPORT: async (_, args, contextValue) => {
            ...
            for (tIdx = 0; tIdx < args.data.length; tIdx++) {
                ...
                var tWExcelFile = `DEBIT(ETP)-${tOne.CRDB_CD}-${tRetDate}`;
                try {
                    // Excel Read
                    var tPath0 = '';
...
*/
        ...
        mgrQueryS070301_4: async (_, args) => {
            var tSQL = '';
...
export default moduleQuery_S070301_4;
