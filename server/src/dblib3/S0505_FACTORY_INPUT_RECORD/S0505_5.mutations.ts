...
const moduleMutation_S0505_5 = {
    Mutation: {
        mgrInsert_S0505_5: async (_, arg, contextValue) => {
            // Update Location
...
*/
        ...
        mgrInsert_S0505_5_1: async (_, args, contextValue) => {
            // End Proc
            var tDateNew = new Date();
            tDateNew.setMonth(tDateNew.getMonth() + 1);
            var tZeroDate = '00';
...
export default moduleMutation_S0505_5;
