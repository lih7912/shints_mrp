...
const moduleQuery_S0303_MRP_RECORD_STYLE_TBL_KSV_PROD_MEM = {
    Query: {
        mgrQuery_S0303_MRP_RECORD_STYLE_TBL_KSV_PROD_MEM: async (_, args) => {
            var tSQL = '';
            ...
            let sqlStr = `
                ...
                from
                    ...
                    left join kcd_matl_sale f on f.matl_cd = a1.matl_cd
                    and f.matl_seq = (
                        select
                            max(matl_seq)
                        from
        ...
        mgrQuery_S0303_MRP_RECORD_STYLE_TBL_KSV_PROD_MEM_BY_USAGE: async (
            _,
            args,
        ) => {
            let sqlStr = `
...
export default moduleQuery_S0303_MRP_RECORD_STYLE_TBL_KSV_PROD_MEM;
