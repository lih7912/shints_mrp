...
const moduleMutation_S041202_5 = {
    Mutation: {
        mgrInsert_S041202_5: async (_, args, contextValue) => {
            //
...
*/
            ...
            args.datas.forEach((col, i) => {
                ...
                let tSQL99 = `
                    ...
                    values
                        ('${col.PACK_CD}', '${col.VENDOR_CD}', '${col.PERMIT}')
                `;
                const tSQL99_1 = prisma.$queryRaw(Prisma.raw(tSQL99));
                tSQLArray.push(tSQL99_1);
            });
...
export default moduleMutation_S041202_5;
