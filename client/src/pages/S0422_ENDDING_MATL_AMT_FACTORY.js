...
import { ServiceS0422_ENDDING_MATL_AMT_FACTORY } from "../service/service_biz/ServiceS0422_ENDDING_MATL_AMT_FACTORY";
...
const S0422_ENDDING_MATL_AMT_FACTORY = () => {
    ...
    const serviceS0422_ENDDING_MATL_AMT_FACTORY =
        new ServiceS0422_ENDDING_MATL_AMT_FACTORY();
    ...
    const searchTBL_KSV_STOCK_IN = () => {
        ...
        // serviceS0422_ENDDING_MATL_AMT_FACTORY.mgrQueryTBL_KSV_STOCK_IN(dataQRY_).then(data => {
        ...
        <div>
            ...
            >
                ...
                >
                    ...
                    <AFColumn field="BUYER" header="Buyer" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    ...
                    <AFColumn field="IN_QTY_TOT" header="In Qty(Tot)" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    <AFColumn field="IN_QTY_PAY" header="In Qty(Pay)" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    <AFColumn field="IN_CURR_CD" header="In Curr" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    <AFColumn field="IN_PRICE" header="In Price" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    <AFColumn field="PAY_CURR_CD" header="Pay Curr" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    <AFColumn field="PAY_PRICE" header="Pay Price" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    <AFColumn field="MATL_PRICE" header="Matl Price" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    <AFColumn field="TT_FLAG" header="T/T" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    <AFColumn field="WARE_NAME" header="Pur Factory" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    <AFColumn field="PAY_AMT" header="Pay Amt" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    <AFColumn field="END_FLAG" header="Close" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    <AFColumn field="END_DATE" header="Close Date" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    ...
                    <AFColumn field="BILL_FLAG" header="Bill" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    <AFColumn field="BILL_DATE" header="Bill Date" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    ...
                    <AFColumn field="IN_DATETIME" header="In Date" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    ...
                    <AFColumn field="CALC_FLAG" header="Calc Flag" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
                    ...
                    <AFColumn field="PUR_FACTORY" header="Pur Factory" headerStyle={{ width: "10rem", height: "1.8rem" }} bodyStyle={{ width: "10rem", height: "1.8rem" }} ></AFColumn>
...
export default React.memo(S0422_ENDDING_MATL_AMT_FACTORY, comparisonFn);
