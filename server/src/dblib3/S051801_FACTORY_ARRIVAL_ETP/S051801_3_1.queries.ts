...
const moduleQuery_S051801_3_1 = {
    Query: {
        mgrQueryS051801_3_1: async (_, args) => {
            var tSQL = '';
            ...
            let sqlStr = `
                ...
                where
                    ...
                    and A.STATUS_CD = '0'
                    and A.DESTINATION = 'ETP'
                    -- and (A.ATA is null  or A.ATA = '')
                group by
                    A.ATA,
                    A.CLEARANCE_NO,
                    A.SHIPMENT_CD,
        ...
        mgrQueryS051801_3_2: async (_, args) => {
            var tSQL = '';
            if (args.data.STYLE_CD !== '') {
                tSQL += `AND STYLE_NAME like '%${args.data.STYLE_CD}%' `;
            }
...
export default moduleQuery_S051801_3_1;
