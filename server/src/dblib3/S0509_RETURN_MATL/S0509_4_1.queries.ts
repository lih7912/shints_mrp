...
const moduleQuery_S0509_4_1 = {
    Query: {
        mgrQueryS0509_4_1: async (_, args) => {
            var tSQL = '';
        ...
        mgrQueryS0509_4_2: async (_, args) => {
            var tSQL = '';
        ...
        // 4_2 Backup
        mgrQueryS0509_4_2_1: async (_, args) => {
            var tSQL = '';
...
export default moduleQuery_S0509_4_1;
