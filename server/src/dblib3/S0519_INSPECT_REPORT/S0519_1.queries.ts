...
const moduleQuery_S0519_1 = {
    Query: {
        mgrQueryS0519_1_CODE: async (_, args) => {
            var tWObj = {};
            let sqlStr = `
                select distinct
        ...
        mgrQueryS0519_1_CODE2: async (_, args) => {
            var tWObj = {};
...
export default moduleQuery_S0519_1;
