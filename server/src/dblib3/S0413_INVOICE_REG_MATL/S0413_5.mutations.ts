...
const moduleMutation_S0413_5 = {
    Mutation: {
        mgrInsert_S0413_5: async (_, args, contextValue) => {
            //
...
*/
            ...
            try {
                ...
                var tRetArray = [];
                var tObj = {};
                tObj.CODE = 'ERROR:Insert INVOICE Error';
                tObj.id = 0;
                tRetArray.push(tObj);
                return tRetArray;
            }
            ...
            var tRetArray = [];
            var tObj = {};
            tObj.CODE = 'SUCCEED:Insert Invoice :' + tInput.INVOICE_NO;
            tObj.id = 0;
            tRetArray.push(tObj);
...
export default moduleMutation_S0413_5;
