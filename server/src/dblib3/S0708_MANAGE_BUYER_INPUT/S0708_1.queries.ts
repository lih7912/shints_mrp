...
const moduleQuery_S0708_1 = {
    Query: {
        mgrQueryS0708_CODE: async (_, args) => {
            var tWObj = {};
            ...
            if (args.data.BUYER_CD === '') {
                ...
                let sqlStr = `
                    SELECT
                        a.INVOICE_NO,
                        (cast(b.part_amt as varchar) '-' b.due_date) as DUE_DATE
                    FROM
                        ksv_invoice_mst a,
                        ksv_invoice_part b
                    WHERE
                        ...
                        and a.reg_datetime between '20200710000000' and '20210608000000'
                    union
                    SELECT
                        invoice_no,
                    ...
                    WHERE
                        ...
                        and invoice_type = '1'
                        and tot_amt > 0
                        and reg_datetime < '20200710000000'
                    union
                    SELECT
                        invoice_no,
                        cast(tot_amt as varchar)
...
export default moduleQuery_S0708_1;
