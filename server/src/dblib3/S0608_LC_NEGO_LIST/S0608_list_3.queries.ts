...
const moduleQuery_S0608_LIST_3 = {
    Query: {
        mgrQueryS0608_LIST_3: async (_, args) => {
            var tSQL = '';
            ...
            let sqlStr = `
                ...
                where
                    ...
                    and (c.buyer_cd = '${args.data.BUYER_CD}')
                group by
                    a.crdb_cd,
                    a.curr_cd,
                    a.crdb_amt,
                    ...
                    a.vat
                having
                    (a.crdb_amt + isnull(a.vat, 0)) - (isnull(sum(b.bill_amt), 0)) > 0
                union
                select
                    a.CRDB_CD,
                    a.CURR_CD,
                ...
                group by
                    ...
                    a.vat
                having
                    (a.crdb_amt + isnull(a.vat, 0)) - (isnull(sum(b.credit_amt), 0)) > 0
                union
                select
                    a.CRDB_CD,
                    a.CURR_CD,
...
export default moduleQuery_S0608_LIST_3;
