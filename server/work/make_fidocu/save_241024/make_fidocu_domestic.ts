...
const process1 = async (argPuCd: string) => {
    ...
    for (tIdx = 0; tIdx < obj0.length; tIdx++) {
        ...
        var m_strTotal =
            parseFloat(obj1['PAY_AMT']) - parseFloat(obj1['VAT_AMT']);
        ...
        var taxAdd0 = '';
        var taxAdd = obj1['TAX_KIND']; // 1:과세, 2: 영세, 3: 면세, 4: TT
        if (obj1['TAX_KIND'] === '1') taxAdd = '3';
        if (obj1['TAX_KIND'] === '2') taxAdd = '2';
        if (obj1['TAX_KIND'] === '3') taxAdd = '1';
        if (obj1['TAX_KIND'] === '4') taxAdd = '4';
        if (m_strPurApp === 'O' && m_strTTFlag === '1') taxAdd0 = '1'; // 면세
        if (m_strPurApp === 'O' && m_strTTFlag !== '1') taxAdd0 = '2'; // 영세
        if (m_strPurApp === 'X' && m_strTTFlag !== '1') taxAdd0 = '3'; // 과세
        if (m_strPurApp === 'X' && m_strTTFlag === '1') taxAdd0 = '4'; // TT
        ...
        if (m_strPurApp === 'O' && m_strTTFlag === '1') {
            strTaxCd = '26';
            strTaxNm = '면세(계산서)';
            strCdAcct = '15400';
            strLocCd = '100';
        ...
        if (m_strPurApp === 'X' && m_strTTFlag !== '1') {
            strTaxCd = '21';
            strTaxNm = '과세(세금계산서)';
            strCdAcct = '15400';
            strLocCd = '100';
        ...
        console.log(
            `>>>>> (1) ${tOne['BILL_CD']} | ${tOne['TAXBILL_CD']} | ${strNeoeNo} | ${strRegNo} | ${strVendorMatlType} `,
        );
