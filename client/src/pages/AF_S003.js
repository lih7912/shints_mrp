...
const AF_S001 = () => {
    ...
    const popup_INFO = (e) => {
        ...
        tQry.ECG = tObj.ECG;
        tQry.ANG = tObj.ANG;
        tQry.LEFT_ANG = tObj.LEFT_ANG;
        tQry.STRENGTH = tObj.STRENGTH;
        tQry.RESULT = tObj.RESULT;
        tQry.RESULT2 = tObj.RESULT2;
        ...
        tObj.MEMS.forEach((col, i) => {
            ...
            tDataAng2.push(parseFloat(tObj.LEFT_ANG));
        ...
        <div className="af-div-main">
            <div style={{ height: "9rem" }}>
                ...
                >
                    ...
                    <span className="af-span-3-0" style={{ width: "21rem" }}>
                        <p className="af-span-p" style={{ width: "8rem" }}>Age</p>
                        <div className="af-span-div" style={{ width: "12rem" }}>
                            <InputText
                                style={{ width: "12rem" }}
                                id="id_TARGET_ETA"
                                value={dataQRY_KSV_PO_MRP.AGE}
                                onChange={(e) =>
                                    onInputChangeQRY_KSV_PO_MRP(e, "AGE")
                                }
                            />
                        </div>
                    </span>
                    ...
                    <span className="af-span-3-0" style={{ width: "21rem" }}>
                        <p className="af-span-p" style={{ width: "8rem" }}>활동시간</p>
                        <div className="af-span-div" style={{ width: "12rem" }}>
                            <InputText
                                style={{ width: "12rem" }}
                                id="id_TARGET_ETA"
                    ...
                    <span className="af-span-3-0" style={{ width: "21rem" }}>
                        <p className="af-span-p" style={{ width: "8rem" }}>거리</p>
                        <div className="af-span-div" style={{ width: "12rem" }}>
                            <InputText
                                style={{ width: "12rem" }}
                                id="id_TARGET_ETA"
                    ...
                    <span className="af-span-3-0" style={{ width: "21rem" }}>
                        <p className="af-span-p" style={{ width: "8rem" }}>ECG</p>
                        <div className="af-span-div" style={{ width: "12rem" }}>
                            <InputText
                                style={{ width: "12rem" }}
                                id="id_TARGET_ETA"
                                value={dataQRY_KSV_PO_MRP.ECG}
                                onChange={(e) =>
                                    onInputChangeQRY_KSV_PO_MRP(e, "ECG")
                                }
                            />
                        </div>
                    </span>
                    <span className="af-span-3-0" style={{ width: "21rem" }}>
                        <p className="af-span-p" style={{ width: "8rem" }}>상체기울기</p>
                        <div className="af-span-div" style={{ width: "12rem" }}>
                            <InputText
                                style={{ width: "12rem" }}
                                id="id_TARGET_ETA"
                                value={dataQRY_KSV_PO_MRP.ANG}
                                onChange={(e) =>
                                    onInputChangeQRY_KSV_PO_MRP(e, "ANG")
                                }
                            />
                        </div>
                    </span>
                    <span className="af-span-3-0" style={{ width: "21rem" }}>
                        <p className="af-span-p" style={{ width: "8rem" }}>무릅각도</p>
                        <div className="af-span-div" style={{ width: "12rem" }}>
                            <InputText
                                style={{ width: "12rem" }}
                                id="id_TARGET_ETA"
                                value={dataQRY_KSV_PO_MRP.LEFT_ANG}
                                onChange={(e) =>
                                    onInputChangeQRY_KSV_PO_MRP(e, "LEFT_ANG")
                                }
                            />
                        </div>
                    </span>
            ...
            >
                ...
                >
                    ...
                    <AFColumn field="AGE" headerClassName="t-header" header="나이" className="af-col" style={{ width: "5rem" }} ></AFColumn>
                    ...
                    <AFColumn field="ECG" headerClassName="t-header" header="ECG" className="af-col" style={{ width: "5rem" }} ></AFColumn>
                    <AFColumn field="ANG" headerClassName="t-header" header="상체기울기" className="af-col" style={{ width: "5rem" }} ></AFColumn>
                    <AFColumn field="LEFT_ANG" headerClassName="t-header" header="무릅각도" className="af-col" style={{ width: "5rem" }} ></AFColumn>
                    <AFColumn field="STRENGTH" headerClassName="t-header" header="운동강도" className="af-col" style={{ width: "5rem" }} ></AFColumn>
                    <AFColumn field="RESULT" headerClassName="t-header" header="상체기울기 평가" className="af-col" style={{ width: "5rem" }} ></AFColumn>
                    <AFColumn field="RESULT2" headerClassName="t-header" header="무릅각도 평가" className="af-col" style={{ width: "5rem" }} ></AFColumn>
                </AFDataTable>
            </div>
            <div
                className="af-div-first"
