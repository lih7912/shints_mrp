...
const moduleMutation_S052001_5 = {
    Mutation: {
        mgrInsert_S052001_5_CANCEL: async (_, args, contextValue) => {
            //
...
*/
            ...
            for (tIdx = 0; tIdx < args.datas.length; tIdx++) {
                ...
                let tSQL99 = `
                    delete from ksv_stock_facout
                    where
                        out_date = '${col.OUT_DATE}'
                        and po_cd = '${col.PO_CD}'
                ...
                let tSQL99 = `
                    ...
                    set
                        outfac_qty = outfac_qty - ${col.OUT_QTY0}
                    where
                        po_cd = '${col.PO_CD}'
                        and matl_cd = '${col.MATL_CD}'
                        -- and   pu_cd = '${col.PU_CD}'
                ...
                var tSaveOutQty = parseFloat(col.OUT_QTY0);
                ...
                for (tIdx0 = 0; tIdx0 < nRet0.length; tIdx0++) {
                    ...
                    if (col1.OUTFAC_QTY > tSaveOutQty) {
                        tOutQty = col1.OUTFAC_QTY - tSaveOutQty;
                        tSaveOutQty = 0;
                    } else {
                        tOutQty = col1.OUTFAC_QTY;
                        tSaveOutQty -= tOutQty;
                    }
        ...
        mgrUpdate_S052001_5_LOCATION: async (_, args, contextValue) => {
            // Update Location
            var tDateNew = new Date();
            tDateNew.setMonth(tDateNew.getMonth() + 1);
            var tZeroDate = '00';
...
export default moduleMutation_S052001_5;
