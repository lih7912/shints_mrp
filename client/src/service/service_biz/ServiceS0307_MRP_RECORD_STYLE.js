...
export class ServiceS0307_MRP_RECORD_STYLE {
    ...
    async mgrQuery_SEARCH_ORDER_CD(argQRY_KSV_PROD_MST) {
        apolloOption.cache = new InMemoryCache();
        const client = new ApolloClient(apolloOption);
        ...
        try {
            const { loading, error, data } = await this.client.query({
                query: gql`
                    query MgrQueryS0307_2_1($data: I_S0307_2_1!) {
                        mgrQueryS0307_2_1(data: $data) {
                            PO_CD
                            ORDER_CD
                            STYLE_CD
                            STYLE_NAME
            ...
            return data.mgrQueryS0307_2_1;
        } catch (e) {
            return e;
        }
    }

    async mgrQuery_SEARCH_PROD_MEM(argQRY_KSV_PROD_MST) {
        apolloOption.cache = new InMemoryCache();
        const client = new ApolloClient(apolloOption);
        ...
        try {
            const { loading, error, data } = await this.client.query({
                query: gql`
                    query MgrQuery_S0307_3_1($data: I_S0307_3_1!) {
                        mgrQuery_S0307_3_1(data: $data) {
                            PROD_CD
                            ORDER_MRP_SEQ
                            VERSION
                            DL_FLAG
            ...
            return data.mgrQuery_S0307_3_1;
        } catch (e) {
            return e;
        }
    }
