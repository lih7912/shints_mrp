// MGR_S043001_1.typeDefs.js

// 데이터 형식(typeDefs) 지정하기 위한 gql 불러오기
import { gql } from 'apollo-server';

// export default 활용해 gql typeDefs 내보내기
const moduleTypedefs_S043001_1 = gql`
    type T_S043001_1 {
        PO_CD: String
        PO_SEQ: Int
        ORDER_CD: String
    ...
    input I_S043001_CODE {
        BUYER_CD: String
    }

    type T_S043001_1_CODE {
    ...
    type Query {
        mgrQueryS043001_1(data: I_S043001_1!): [T_S043001_1!]!
        mgrQueryS043001_1_CODE: T_S043001_1_CODE!
        mgrQueryS043001_1_CODE2(data: I_S043001_CODE!): T_S043001_1_CODE2!
    }
`;

export default moduleTypedefs_S043001_1;
