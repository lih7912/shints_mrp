...
const moduleMutation_S0506_5 = {
    Mutation: {
        mgrInsert_S0506_5: async (_, args, contextValue) => {
            // Update Location
...
*/
            ...
            for (tIdx = 0; tIdx < args.datas.length; tIdx++) {
                ...
                let tSQL99 = `
                    delete ksv_stock_facout
                    where
                        po_cd = '${tOne.PO_CD}'
                        and matl_cd = '${tOne.MATL_CD}'
                        and out_date = '${tOne.OUT_DATE}'
        ...
        mgrInsert_S0506_5_1: async (_, args, contextValue) => {
            // End Proc
            var tDateNew = new Date();
            tDateNew.setMonth(tDateNew.getMonth() + 1);
            var tZeroDate = '00';
...
export default moduleMutation_S0506_5;
