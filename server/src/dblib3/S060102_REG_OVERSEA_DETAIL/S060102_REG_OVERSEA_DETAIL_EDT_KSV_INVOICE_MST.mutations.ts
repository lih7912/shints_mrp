...
const moduleMutation_S060102_REG_OVERSEA_DETAIL_EDT_KSV_INVOICE_MST = {
    Mutation: {
        mgrInsert_S060102_REG_OVERSEA_DETAIL_EDT_KSV_INVOICE_MST: async (
            _,
            args,
        ) => {
            //
...
*/
            ...
            for (tIdx = 0; tIdx < args.datas.length; tIdx++) {
                ...
                var tObjEDT_KSV_INVOICE_MST = { ...tData };
                delete tObjEDT_KSV_INVOICE_MST.id;

                /*
        let retInsert = await prisma.EDT_KSV_INVOICE_MST.create({data:tObj@@TNAME@@});
...
*/
        ...
        mgrUpdate_S060102_REG_OVERSEA_DETAIL_EDT_KSV_INVOICE_MST: async (
            _,
            args,
        ) => {
            //
...
*/
        ...
        mgrDelete_S060102_REG_OVERSEA_DETAIL_EDT_KSV_INVOICE_MST: async (
            _,
            args,
        ) => {
            //
...
export default moduleMutation_S060102_REG_OVERSEA_DETAIL_EDT_KSV_INVOICE_MST;
