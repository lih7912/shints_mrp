// MGR_S0431_1.typeDefs.js

// 데이터 형식(typeDefs) 지정하기 위한 gql 불러오기
import { gql } from 'apollo-server';

// export default 활용해 gql typeDefs 내보내기
const moduleTypedefs_S0431_1 = gql`
    type T_S0431_1 {
        PO_CD: String
        PO_SEQ: Int
        ORDER_CD: String
    ...
    type T_S0431_1_CODE {
        ...
        RECEIVER: [BASE_QRY_KCD_USER!]!
    }

    type T_S0431_1_CODE2 {
    ...
    type Query {
        mgrQueryS0431_1(data: I_S0431_1!): [T_S0431_1!]!
        mgrQueryS0431_1_CODE: T_S0431_1_CODE!
        mgrQueryS0431_1_CODE2(data: I_S0431_CODE!): T_S0431_1_CODE2!
    }
`;

export default moduleTypedefs_S0431_1;
