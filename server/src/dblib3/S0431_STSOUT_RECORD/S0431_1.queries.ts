...
const moduleQuery_S0431_1 = {
    Query: {
        mgrQueryS0431_1_CODE: async (_, args) => {
            var tWObj = {};
            let sqlStr = `
                select distinct
        ...
        mgrQueryS0431_1_CODE2: async (_, args) => {
            var tWObj = {};
...
export default moduleQuery_S0431_1;
